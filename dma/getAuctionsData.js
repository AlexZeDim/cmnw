    ...
    try {
        ...
        await realms_db.aggregate([
            ...
            try {
                ...
                let {auctions, lastModified} = await bnw.WowGameData.getAuctionHouse(_id.connected_realm_id, _id.timestamp).catch(e => {console.info(`E,${_id.connected_realm_id}:${e}`); return (e)});
